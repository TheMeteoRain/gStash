...
const COLUMN_SET_PROPERTIES = new pgp.helpers.ColumnSet(['item_id', 'property_name', 'property_value', 'property_value_type', 'property_display_mode', 'property_progress'], { table: 'properties' })
